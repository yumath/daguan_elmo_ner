...
### Installing
Install python version 3.5 or later, tensorflow version 1.12 and h5py:

```
pip install tensorflow-gpu==1.12 h5py
...
#### 3. Convert the tensorflow checkpoint to hdf5 for prediction with `bilm`.
